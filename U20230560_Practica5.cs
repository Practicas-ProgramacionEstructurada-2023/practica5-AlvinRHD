...
namespace MyApp// Note: actual namespace depends on the project name.
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("\n****Calculadora de promedio de universidad*****");

            //Solicitando al estudiante que ingrese las notas del primer c
            ...
            // Solicitando al estudiante que ingrese las notas del segundo c
            ...
            // Solicitando al estudiante que ingrese las notas del tercer c
            Console.WriteLine("\nIngrese las notas del segundo computo");
